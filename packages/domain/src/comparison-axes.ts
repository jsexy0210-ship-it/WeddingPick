...
/**
 * 무엇을 나란히 놓고 견줄 것인가. 통합정책 v3.12 §5.
 *
 * v3.12가 비교에 실을 것을 여덟 가지로 늘렸다. 늘리는 것 자체보다 **어느 값이
 * 누구 말인지 갈라두는 것**이 요점이다.
 *
 ...
 *
 * **순위를 매기지 않는다.** v3.10 §9와 v3.12 §5가 비교 화면에서 가격 가치판단을 금지했다.
 * 이 파일에는 정렬도 점수도 `best`도 없다. 어느 곳이 나은지는 사용자가 정한다.
 */
