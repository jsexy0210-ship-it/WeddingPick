...
export interface TermsArticle { t: string; l: string[] }

export function termsArticles(CONTACT_EMAIL: string | null = null): TermsArticle[] { return [
...
export function privacySections(CONTACT_EMAIL: string | null = null): PrivacySection[] { return [
  {
