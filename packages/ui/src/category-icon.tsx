 ...
 * 손대지 않는다. 혼수·청첩장은 v3.18 §1.3 업종 10종을, 헤어변형·부케는 v3.22 §13.6
 * 업종 12종을 채우려고 같은 규격으로 그린 것이다(핸드오프에 글리프가 없다).
 */
...
const GLYPH: Record<CategoryIconKind, [string, string]> = {
  ...
  /* 헤어변형 — 빗. 손잡이 하나와 빗살 넷. */
  hair: [
    'M5.2 4.6h13.6a1.4 1.4 0 0 1 1.4 1.4v2.6H3.8V6a1.4 1.4 0 0 1 1.4-1.4zM3.8 8.6h16.4',
    'M6.6 8.6v10.8M10.2 8.6v8.2M13.8 8.6v8.2M17.4 8.6v10.8',
  ],
  snap: [
  ...
  /* 부케 — 꽃 세 송이와 묶은 줄기. */
  bouquet: [
    'M12 9.2a2.6 2.6 0 1 0 0-5.2 2.6 2.6 0 0 0 0 5.2zM6.2 11.6a2.4 2.4 0 1 0 0-4.8 2.4 2.4 0 0 0 0 4.8zM17.8 11.6a2.4 2.4 0 1 0 0-4.8 2.4 2.4 0 0 0 0 4.8z',
    'M12 9.2v6.2M6.8 11.4 11 15.6M17.2 11.4 13 15.6M12 15.4l-2.4 5.2M12 15.4l2.4 5.2M9.4 18.2h5.2',
  ],
