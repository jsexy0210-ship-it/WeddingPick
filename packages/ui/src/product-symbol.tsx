...
export function ProductSymbol({ name, size = 24, color = Colors.light.text }: { name: ProductSymbolName; size?: number; color?: ColorValue }) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      {name === 'pickMark' && <><Path {...common} d="M12 20.5S3.5 15.2 3.5 9.9A4.4 4.4 0 0 1 12 8.1a4.4 4.4 0 0 1 8.5 1.8c0 5.3-8.5 10.6-8.5 10.6Z" /><Path {...common} d="m8.7 11.9 2.2 2.2 4.4-4.4" /></>}
