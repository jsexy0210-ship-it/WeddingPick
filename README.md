...
Phase 2에서는 업체 검색(A-16)과 업체 상세(A-17)가 동작한다. 별점도 후기도 순위도 없다 — 보여주는 것은 업체가 있다는 사실, 분류와 지역, 확인된 계약이 몇 건 모였는지, 그리고 표본이 충분한 상품의 실제 계약 중앙값뿐이다. 자료가 없으면 없다고 적는다. 플래너 탐색과 3곳 비교는 아직 만들지 않았다.
