...
- 사용자 로그인: `https://210.109.82.212/login` (KakaoCloud 443)
- API: `https://210.109.82.212` (같은 443에서 `/v1/*` · `/health`)
- 관리자 로그인: `https://210.109.82.212/admin/login` (KakaoCloud 443 고정)
- 웹사이트·약관: 같은 443에서 `/website.html` · `/privacy.html` · `/terms.html`

공개 주소에 별도 포트를 붙이지 않는다. 사용자와 관리자는 위 두 로그인 주소를 정본으로 사용한다.
