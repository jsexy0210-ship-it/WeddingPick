...
- **플래너 공개 근거를 만드는 절차** — 규칙과 스키마 제약은 있지만 넣는 쪽이 없어 지금은 목록이 비어 있다. 공개 자료 수집 경로, 본인·업체의 등록 요청 창구, 그리고 노출 중단 요청을 받을 창구가 필요하다.

자세한 것은 [제품·기술 명세 12번 열린 질문](docs/05-product-spec.md).
