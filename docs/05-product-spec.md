...
**구현 현황** (2026-08-28): A-03 홈, A-04 촬영, A-05 문서 확인, A-11 내 웨딩, A-12 견적 상세, A-13 인증 등급, A-14 MY, A-15 정책이 동작한다. A-06~A-10(분석 중·확인 단계·분석 결과·가격 비교·계약조건 체크)은 AI 분석과 서버가 필요해 아직 없다. A-01 온보딩과 A-02 로그인은 인증 제공자 확정 후.
