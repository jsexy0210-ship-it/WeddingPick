...
const source = readFileSync(path.join(repoRoot, 'scripts/install-kakao-app-web.sh'), 'utf8');

test('app-web proxy overwrites forwarded client IP with nginx peer address', () => {
