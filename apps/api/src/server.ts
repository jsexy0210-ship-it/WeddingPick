...
import { registerAdminRetentionRoutes } from './routes/admin-retention';
import { registerAdminRewardRoutes } from './routes/admin-rewards';
...
import { registerAdminVerificationRoutes } from './routes/admin-verifications';
...
export function buildServer(context: AppContext): FastifyInstance {
  ...
  registerAdminVerificationRoutes(app, context);
  registerAdminPiiRoutes(app, context);
  registerAdminInquiryRoutes(app, context);
  ...
  registerAdminRetentionRoutes(app, context);
  registerAdminRewardRoutes(app, context);
