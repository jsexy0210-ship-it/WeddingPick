...
/**
 * 사용자 앱에 `결제`가 다시 들어오는 것을 막는다. 통합정책 v3.13 §O-1·§O-10.
 *
 * §O-1이 사용자 앱 일반 UI에서 `결제`와 파생 표현을 전면 금지하고 `Pick 인증`
...
describe('사용자 앱 Pick 언어', () => {
  ...
  it('화면에 나가는 말에 견적·계약서가 없다', () => {
    /*
     * §O-10이 더한 금지다. 사용자가 올리는 것은 `Pick 인증 자료`이고, 그것이
