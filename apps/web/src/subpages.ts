...
const PRIVACY_SECTIONS: PrivacySection[] = [
  {
    ...
    rows: [
      ...
      ['상담기록 정리(선택)', '이용자가 올린 상담 녹음 파일, 그 녹음에서 읽어낸 업체명·상담일·금액·상품 구성·계약 조건·상담 요약, 금액 항목의 근거가 된 짧은 인용(40자 이내)', '녹음 원본은 읽어내기가 끝나면 바로 삭제하고, 끝나지 않은 경우에도 업로드 시점부터 24시간 안에 삭제합니다. 읽어낸 항목은 직접 삭제 또는 탈퇴 시까지 보관합니다. 녹취록은 만들지 않습니다'],
  ...
  },
  {
    ...
    rows: [
      ...
      [
        ...
        '미국 · 상담 녹음에서 업체명·금액·계약 조건 등 필요한 항목을 읽어내기 위해',
        '이용자가 올린 상담 녹음 파일 전체(업체명, 금액, 상담 내용, 대화에 등장하는 사람의 이름과 연락처가 함께 담겨 있을 수 있습니다). 이용자가 파일을 올려 분석이 시작되는 시점에, 암호화된 통신구간을 통해 사업자의 응용프로그램 인터페이스로 전송합니다. 보존기준은 사업자가 공개한 정책을 따르며, 회사 저장소의 원본 삭제 일정과는 별도입니다. 회사는 이 이전을 유료 API 경로로만 수행하고 모델 학습에 이용되지 않는 조건으로 처리합니다.',
      ],
      [
