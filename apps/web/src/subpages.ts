...
const PRIVACY_SECTIONS: PrivacySection[] = [
  {
    ...
    rows: [
      ['회원가입·계정', '소셜 제공자(필수), 제공자별 회원 식별자(필수), 필수 동의 이력(필수), 가입·활성화 일시(필수)', '탈퇴 시까지. 법정 보관 또는 분쟁처리가 필요한 경우 해당 기간'],
      ['만 14세 이상 확인', '연령대(필수)', '가입 판정 직후 삭제하며 저장하지 않습니다. 확인 결과와 확인 시각만 탈퇴 시까지 보관합니다'],
      ['소셜 프로필 기본값', '별명(필수), 프로필 사진(필수), 카카오계정 이메일(필수), 전화번호(선택) 중 제공자가 이용자 동의에 따라 전달한 항목', '계정 연결 해제, 직접 삭제 또는 탈퇴 시까지. 원본 응답 전체는 장기 보관하지 않음'],
    ...
    lead: '괄호 안은 회원가입 시 동의 조건입니다. 선택정보를 제공하지 않아도 해당 선택 기능을 제외한 기본 서비스를 이용할 수 있습니다. 소셜 제공자가 항목을 전달하지 않으면 필요한 경우에만 추가 입력을 요청합니다.',
  },
  ...
  { t: '8. 만 14세 미만 아동', l: ["웨딩픽은 만 14세 미만의 회원가입을 받지 않습니다.", "가입 과정에서 소셜 제공자가 전달한 연령대를 받아 만 14세 이상인지만 확인합니다. 생년월일과 출생 연도는 받지 않습니다.", "연령대는 판정 직후 삭제하며 저장하지 않습니다. 남기는 것은 확인 결과와 확인 시각뿐입니다."] },
