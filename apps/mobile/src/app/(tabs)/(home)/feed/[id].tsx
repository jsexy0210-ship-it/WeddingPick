 ...
 *
 * 피그마가 찍어낼 수 있는 화면은 열둘뿐이고(`scripts/screenshot-figma.mjs` `ROUTES`)
 * 거기 글 상세가 없다. 그래서 처음에는 「피그마에 없는 화면」으로 보고 업체 상세의
 * 규칙을 빌려 왔는데, **피그마 저장소를 열어 보니 글 상세가 있었다** — 라우터에 안
 * 걸린 `FeedDetailPage`다. 라우트 목록만 보고 「없다」고 적을 뻔했다.
 *
 * 그 화면에서 그대로 가져온 것:
 *
 *   좌우 20            `Layout.gutter` — `px-5`
