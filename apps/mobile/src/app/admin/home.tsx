...
const styles = StyleSheet.create({
  ...
  metricCardUrgent: { borderColor: Colors.light.negative, backgroundColor: Colors.light.negativeBackground },
  ...
  killBtnActive: { backgroundColor: Colors.light.negativeBackground, borderColor: Colors.light.tint },
