...
const styles = StyleSheet.create({
  ...
  policyRowZebra: { backgroundColor: Colors.light.backgroundElement },
  policyMain: { flex: 1, marginRight: 16 },
  policyLabel: { fontSize: FontSize.t7, fontWeight: '700', color: Colors.light.text, marginBottom: 2 },
  policyKey: { fontSize: FontSize.tab, color: Colors.light.textDisabled, fontFamily: 'monospace', marginBottom: 2 },
  policyDesc: { fontSize: FontSize.tab, color: Colors.light.textAssistive, lineHeight: LineHeight.micro, marginBottom: 4 },
  policyMeta: { fontSize: FontSize.tab, color: Colors.light.textDisabled },
  policyRight: { alignItems: 'flex-end', gap: 4 },
  policyValue: { fontSize: FontSize.t7, fontWeight: '700', color: Colors.light.text, fontVariant: ['tabular-nums'] },
  policyDefault: { fontSize: FontSize.tab, color: Colors.light.textAssistive },
  editBtn: {
  ...
  modalBox: { backgroundColor: Colors.light.background, borderRadius: 14, padding: 24, width: 480 },
  modalTitle: { fontSize: FontSize.t6, fontWeight: '700', color: Colors.light.text, marginBottom: 4 },
  modalDesc: { fontSize: FontSize.t7, color: Colors.light.textAssistive, marginBottom: 4 },
  modalKey: { fontSize: FontSize.tab, color: Colors.light.textDisabled, fontFamily: 'monospace', marginBottom: 12 },
  fieldLabel: { fontSize: FontSize.t7, fontWeight: '700', color: Colors.light.textAssistive, marginBottom: 6 },
  fieldInput: {
    borderWidth: 1,
    borderColor: Colors.light.fieldBorder,
    borderRadius: 6,
  ...
  defaultHint: { fontSize: FontSize.tab, color: Colors.light.textDisabled, marginTop: 4 },
