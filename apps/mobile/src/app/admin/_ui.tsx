...
export type AdminTabDef = {
   ...
   * (2026-09-16에 약관·방침이 빠졌다 — 편집·공개가 열렸다. 0420) */
  readOnly?: boolean;
};
...
const styles = StyleSheet.create({
  ...
  toggle: { width: A.toggleWidth, height: A.toggleHeight, borderRadius: Radius.pill, padding: A.stackGap, justifyContent: 'center' },
  ...
  loadError: { alignItems: 'center', gap: A.tableGap, padding: A.bodyPaddingX },
