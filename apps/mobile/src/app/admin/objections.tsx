...
const styles = StyleSheet.create({
  ...
  colTitle: { flex: 1 },
  colUntil: { width: 148 },
  overdueText: { color: '#e53e3e' },
  overdueBadge: { fontSize: FontSize.badge, color: '#e53e3e', fontWeight: '700' },
  ...
  restoreBtn: { flex: 1, paddingVertical: 10, borderRadius: 6, alignItems: 'center', backgroundColor: '#17181c' },
  restoreBtnText: { color: '#fff', fontSize: FontSize.t7, fontWeight: '700' },
  removeBtn: {
    flex: 1,
    paddingVertical: 10,
    borderRadius: 6,
  ...
  removeBtnText: { color: '#e53e3e', fontSize: FontSize.t7, fontWeight: '700' },
  ...
  extendBtnText: { color: '#3a3b40', fontSize: FontSize.t7, fontWeight: '700' },
