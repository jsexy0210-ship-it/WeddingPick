...
const styles = StyleSheet.create({
  ...
  emptyInline: { color: '#868b94', fontSize: FontSize.t7 },
  ...
  hintRowDone: { borderColor: '#e4e5ea', backgroundColor: '#f8f9fa' },
  hintTexts: { flex: 1 },
  hintField: { fontSize: FontSize.t7, color: '#17181c', fontWeight: '600' },
  hintKind: { fontSize: FontSize.badge, color: '#868b94' },
  hintAction: { fontSize: FontSize.t7, fontWeight: '700', color: '#e53e3e' },
  hintActionDone: { color: '#868b94' },
  actionErrorText: { color: '#e53e3e', fontSize: FontSize.t7, marginTop: 12 },
  cleanBtn: {
    marginTop: 20,
    paddingVertical: 10,
    borderRadius: 6,
  ...
  cleanBtnText: { color: '#fff', fontSize: FontSize.t7, fontWeight: '700' },
