...
const styles = StyleSheet.create({
  ...
  /*
   * v3.28 풀팝업 — 좌측 X 닫기 + 중앙 타이틀(`docs/design/README.md` 「공통 풀팝업」 ·
   * 시안 `certNav`: navClose 40 · navTitle flex:1 가운데 · navPad 40). 오른쪽 액션이 없으면
   * 닫기 단추와 같은 폭의 빈 칸을 두어 제목이 화면 가운데 앉는다. «<» 헤더는 그대로다.
   */
