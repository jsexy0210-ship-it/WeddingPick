...
import { OnboardingDatePickerSheet } from './date-picker-sheet';
    ...
    act(() => {
      tree = create(
        <SafeAreaProvider initialMetrics={METRICS}>
          <OnboardingDatePickerSheet visible value={value} today={today} onConfirm={onConfirm} onDismiss={jest.fn()} />
        </SafeAreaProvider>
      );
    });
